...
def can_be_instantiated_and_then_saved
  ...
  movie.save #returns true or false
end
...
def can_be_created_in_a_block(args = {:title => "Home Alone", :release_date => 1990})#title: "example"
...
def can_get_the_first_item_in_the_database
  Movie.first #.all gets all the rows then uses .first to get the first one
end
